...
namespace ZooAndAnimalFun.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ZooAndAnimalFunContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerID,FirstName,LastName,Address1,Address2,City,State,ZIP,Phone,Email")] Customer customer)
        {

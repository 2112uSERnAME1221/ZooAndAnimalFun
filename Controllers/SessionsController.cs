...
namespace ZooAndAnimalFun.Controllers
{
    public class SessionsController : Controller
    {
        ...
        public SessionsController(ZooAndAnimalFunContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("SessionID,TicketID,EventID,VenueID")] Session session)
        {

...
namespace ZooAndAnimalFun.Controllers
{
    public class HealthStatusController : Controller
    {
        ...
        public HealthStatusController(ZooAndAnimalFunContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(string? id)
        {
            ...
            var healthStatus = await _context.HealthStatus
                .FirstOrDefaultAsync(m => m.HealthStatusId == id);
        ...
        public async Task<IActionResult> Create([Bind("HealthStatusId,HealthDescription")] HealthStatus healthStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("HealthStatusId,HealthDescription")] HealthStatus healthStatus)
        {
        ...
        private bool HealthStatusExists(string id)
        {
